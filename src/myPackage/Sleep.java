...
public class Sleep {
	public enum THE { PVP_MENU, MAIN_MENU, BOARD_IS_READY, BATTLE_IS_READY, CARDS_ARE_STEADY, CHESTS_ARE_OPEN, OKEY_BUTTON_APPEARED, CHEST_MENU_OPEN, QUEST_FIGHT_READY, TRAITSTONE_FIGHT_READY, TROOPS_MENU_OPEN }
